...
| 光斑   | 入射光通道 | 反射光通道 | 入射光效率系数 | 反射光效率系数 |
|--------|-----------|-----------|--------------|--------------|
| 光斑1  | 5         | 9         | 1.0          | 2.2748       |
| 光斑2  | 6         | 10        | 1.0          | 2.15598      |
| 光斑3  | 7         | 11        | 1.0          | 2.18705      |
| 光斑4  | 8         | 12        | 1.0          | 2.11911      |
| 光斑5  | 1         | 2         | 1.0          | 1.0          |
| 光斑6  | 3         | 4         | 1.0          | 1.0          |
...
- **入射光/反射光效率系数** — 每对传感器独立设置，默认 1.0（光斑1~4 的反射光效率系数已预设）
- **合格范围** — 衍射效率的 min/max 阈值（默认 0.5~1.0），热力图用颜色区间标识
